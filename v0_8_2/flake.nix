{
  ...
  inputs.src-imageman-v0_8_2.flake = false;
  inputs.src-imageman-v0_8_2.ref   = "refs/tags/v0.8.2";
  inputs.src-imageman-v0_8_2.owner = "SolitudeSF";
  inputs.src-imageman-v0_8_2.repo  = "imageman";
  inputs.src-imageman-v0_8_2.dir   = "";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-imageman-v0_8_2"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-imageman-v0_8_2";
